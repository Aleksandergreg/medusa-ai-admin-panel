...
${resultData}
\`\`\`
Please provide a brief, natural, human-friendly summary. Include all fields from the body (YOU MUST INCLUDE STATUS AND START AND END DATE). Start with a success emoji (e.g., ✅ or 🎉).`;
